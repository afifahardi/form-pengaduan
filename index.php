...
<body>
	...
	<div class="hero">
		<nav>
			...
			<button type="button"><a href="user/login/login.php">Login</a></button>
		</nav>
	</div>
...
<center>
	...
	<div class="login-form">
		<div class="sign-in-htm">
				<div class="group">
					<input  type="text" class="input"  placeholder="Masukkan NIK" readonly>
				</div>

				<div class="group">
					<input  type="text" class="input"  placeholder="Pilih Tanggal lapor" readonly>
				</div>

				<div class="group">
					<textarea placeholder="Masukkan Laporan" style="resize: none;" readonly></textarea>
				</div>
				...
				<div class="group">
					...
					<h3 style="color: red; font-family: times new roman; font-size: 15px;">Login terlebih dahulu untuk dapat mengirim pengaduan!</h3>
		</div>
	</div>
</div>
</div>
